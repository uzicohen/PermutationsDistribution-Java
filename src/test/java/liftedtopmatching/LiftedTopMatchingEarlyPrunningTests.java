 ...
 */
public class LiftedTopMatchingEarlyPrunningTests extends TestCase {
	 ...
	 */
	public LiftedTopMatchingEarlyPrunningTests(String testName) {
		super(testName);
	...
	public static Test suite() {
		return new TestSuite(LiftedTopMatchingEarlyPrunningTests.class);
	}
